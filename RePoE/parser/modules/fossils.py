            ...
            root[base_item_key] = {
                ...
                "negative_mod_weights": [
                    ...
                    for tag, value in zip(
                        row["NegativeWeight_TagsKeys"], row["NegativeWeight_Values"]
                    )
                ],
                ...
                "forbidden_tags": [
                    tag["TagsKey"]["Id"]
                    for tag in row["ForbiddenDelveCraftingTagsKeys"]
                ],
                "allowed_tags": [
                    tag["TagsKey"]["Id"] for tag in row["AllowedDelveCraftingTagsKeys"]
                ],
