    ...
    def write(
        ...
        for mod in relational_reader["Mods.dat"]:
            ...
            obj = {
                ...
                "generation_weights": _convert_generation_weights(
                    mod["GenerationWeight"]
                ),
                "grants_buff": _convert_buff(
                    mod["BuffDefinitionsKey"], mod["BuffValue"]
                ),
                "grants_effects": _convert_granted_effects(
